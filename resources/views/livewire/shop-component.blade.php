            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget filter-widget price-filter">
                    ...
                    <div class="widget-content">
                        ...
                        <p>
                            <label for="amount">min Price:</label>
                            <input type="text" id="min_amount"  wire:model='minPrice'>
                            <label for="amount">max Price:</label>
                            <input type="text" id="max_amount"  wire:model='maxPrice' >
                        </p>
                    </div>
                </div><!-- Price-->
                                    ...
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            @if ($popular_product->sale_price != NULL)
                                                <div class="wrap-price"><ins><p class="product-price">${{$popular_product->sale_price}}</p></ins> <del><p class="product-price">${{$popular_product->regular_price}}</p></del></div>
                                            @else
