					...
					<div class=" main-content-area">
						<div class="wrap-login-item ">						
							<div class="login-form form-item form-stl">
								...
								<form method="POST" action="{{ route('password.update') }}" name="frm-login">
                                    @csrf
                                    <input type="hidden" name="token" value="{{ $request->route('token') }}">
									...
									<fieldset class="wrap-input">
										...
										<input type="text" id="frm-login-uname" name="email" placeholder="Type your email address to reset password" value="{{old('email', $request->email)}}"required autofocus>
									</fieldset>
